...
// Warning Icon Filled (for alerts)
export const WarningFilledIcon = ({ className = "w-6 h-6", ...props }) => (
...
// Arrow Down Icon
export const ArrowDownIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
// Arrow Up Icon
export const ArrowUpIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
...
// Eye Slash Icon (for password hidden)
export const EyeSlashIcon = ({ className = "w-6 h-6", ...props }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} {...props}>
